import type { PromotionSuggestion } from "../../../api/models/AnalysisModel"

export type AnalysisModel = PromotionSuggestion
...
export function toAnalysis(dto: PromotionSuggestion): Analysis {
    return {
        summary: dto.summary,
